                ...
                <Grid className={classes.vehicleCart}>
                        ...
                        <Grid className={classes.vehicleDetails}>
                            ...
                            <Grid className={classes.vehicleDetailsCard}>
                                <Grid className={classes.vehicleSubDetailsCard}>
                                    <Typography style={{fontSize:'16px',marginLeft:'10px',color:'orange'}}>Daily Rate 5500(Rs) </Typography>
                                ...
                                <Grid className={classes.vehicleSubDetailsCard}>
                                    <Typography style={{fontSize:'16px',marginLeft:'10px',color:'orange'}}>Monthly Rate 120,330.00(Rs)</Typography>
                    ...
                    <Grid className={classes.vehicle}>
                        ...
                        <Grid className={classes.vehicleDetails}>
                            ...
                            <Grid className={classes.vehicleDetailsCard}>
                                <Grid className={classes.vehicleSubDetailsCard}>
                                    <Typography style={{fontSize:'16px',marginLeft:'10px',color:'orange'}}>Daily Rate 5800(Rs) </Typography>
                                    <Typography style={{fontSize:'16px',marginLeft:'10px',color:'orange'}}>Free 100 Km for a Day</Typography>
                                    <Typography style={{fontSize:'16px',marginLeft:'10px',color:'orange'}}>Price per Extra Km 60.00(Rs)</Typography>
                                </Grid>
                                <Grid className={classes.vehicleSubDetailsCard}>
                                    <Typography style={{fontSize:'16px',marginLeft:'10px',color:'orange'}}>Monthly Rate 155,760.00(Rs)</Typography>
                                    <Typography style={{fontSize:'16px',marginLeft:'10px',color:'orange'}}>Free 2400 Km for a Day</Typography>
                                    <Typography style={{fontSize:'16px',marginLeft:'10px',color:'orange'}}>Modifications</Typography>
                                </Grid>
                                <Grid style={{display:'flex', flexWrap: 'wrap', flexDirection: 'column',width:'37vw',height:'5vh',marginTop:'-70px'}}>
                    ...
                    <Grid className={classes.vehicle}>
                        ...
                        <Grid className={classes.vehicleDetails}>
                            ...
                            <Grid className={classes.vehicleDetailsCard}>
                                <Grid className={classes.vehicleSubDetailsCard}>
                                    <Typography style={{fontSize:'16px',marginLeft:'10px',color:'orange'}}>Daily Rate 6000(Rs) </Typography>
                                    <Typography style={{fontSize:'16px',marginLeft:'10px',color:'orange'}}>Free 100 Km for a Day</Typography>
                                    <Typography style={{fontSize:'16px',marginLeft:'10px',color:'orange'}}>Price per Extra Km 65.00(Rs)</Typography>
                                </Grid>
                                <Grid className={classes.vehicleSubDetailsCard}>
                                    <Typography style={{fontSize:'16px',marginLeft:'10px',color:'orange'}}>Monthly Rate 175,230.00(Rs)</Typography>
                                    <Typography style={{fontSize:'16px',marginLeft:'10px',color:'orange'}}>Free 2400 Km for a Day</Typography>
                                    <Typography style={{fontSize:'16px',marginLeft:'10px',color:'orange'}}>Modifications</Typography>
                                </Grid>
                                <Grid style={{display:'flex', flexWrap: 'wrap', flexDirection: 'column',width:'37vw',height:'5vh',marginTop:'-70px'}}>
